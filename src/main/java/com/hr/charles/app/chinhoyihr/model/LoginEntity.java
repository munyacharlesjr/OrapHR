 ...
 *
 */
package com.hr.charles.app.chinhoyihr.model;
...
public class LoginEntity {
    ...
    /* Constructor */
    public LoginEntity(int sr, String login, String password, String question, String answer, String name, String status, String time)
    {
        setSr(sr);
        setLogin(login);
    ...
    public LoginEntity(String question, String ans) {
        setQuestion(question);
        setAnswer(ans);
    }
