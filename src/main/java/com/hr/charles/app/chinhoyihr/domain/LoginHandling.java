...
public class LoginHandling {
   ...
   private static ArrayList<LoginEntity> loginList = new ArrayList();
        ...
        if(resultSet == null)
         ...
         try{
            while(resultSet.next()){
              ...
              loginList.add(new LoginEntity(Integer.parseInt(resultSet.getObject(1).toString()),resultSet.getObject(2).toString(),
   ...
   public static void save(LoginEntity login)
   {
       try {
    ...
    public static LoginEntity searchByID(int sr)
    {
        try
        {
            load();
    ...
    public static ArrayList<LoginEntity> search(String search)
    {
         load();
         ArrayList<LoginEntity> send = new ArrayList<>();
         for (int i =0; i < loginList.size();i++){
    ...
    /*Unique Check of ID*/ 
    private static void uniqueCheck(LoginEntity login)
    {
        for(int i=0; i<loginList.size(); i++)
        {
    ...
    public static ArrayList<LoginEntity> getArray()
    {
       return loginList;
    }
}
